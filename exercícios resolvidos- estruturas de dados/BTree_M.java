public class BTree_M
{
	...
	public	NodoAB deleteNode(int iE, NodoAB ndNo)
	{
		...
		if(ndNo != null)
		{
			...
			else
			{
				...
				else	ndNo.setLeft(deleteNode(iE,ndNo.getLeft()));
				ndRet = ndNo;
			}
		}
		return	ndRet;
	...
	public	boolean	 isInTree(int iE, NodoAB ndNo)
	{
		...
		if(ndNo != null)
		{
			if(iE == ndNo.getElement())	bResp = true;
			else
			{
				if(iE < ndNo.getElement())
				{
					if(isInTree(iE, ndNo.getLeft()))	bResp = true;
				}
				else
				{
					if(isInTree(iE, ndNo.getRight()))	bResp = true;
				}
			}
		}
		return	bResp;
	...
	public String getTreeTrack(char cTipo, NodoAB ndNo)
	{
		String	sIO = "";
		if(ndNo != null)
		{
